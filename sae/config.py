...
@dataclass
class JRSaeConfig(Serializable):
    """
    Configuration for training a sparse autoencoder on a language model.
    """

    beta: float = 2/3
    """Beta for the L0 loss."""
    ...
    """Temperature for the l0 approximation."""
...
@dataclass
class JRTrainConfig(Serializable):
    sae: JRSaeConfig
    ...
    target_l0: int = 128
    """Target sparsity level for the L0 loss."""
    
    l0_coef: float = 0.1
    """L0 regularization coefficient."""
